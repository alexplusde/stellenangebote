            ...
            <div class="card-body">
                ...
                <ul class="job-card-tags-list list-unstyled">
                    <li class="job-card-tag job-card-tag-location text-body">
                        <i class="bi bi-geo-fill"></i> <span class="">Ort:</span> <?= $stellenangebot->getLocationNames() ?>
                    </li>
                </ul>
            </div>
        </a>
...
?>
    ...
    <div class="row pt-4">
            <div class="text-center col-lg-12">
                <a href="<?= rex_getUrl(rex_config::get('stellenangebote', 'category_id')) ?>" class="btn job-detail-btn btn-primary">Alle Jobs gibt es
                    hier</a>
            </div>
        </div>
    </div>
